...
import com.baoitmo.labs.itmoshopping.activity.CartActivity;
import com.baoitmo.labs.itmoshopping.activity.MainActivity;
import com.baoitmo.labs.itmoshopping.adapter.CheckoutCartAdapter;
import com.baoitmo.labs.itmoshopping.model.Cart;
import com.baoitmo.labs.itmoshopping.model.Order;
...
public class ConfirmFragment extends Fragment {
    ...
    private void closeProgress() {
        ...
        Order order = new Order(id, orderNo, currentDateandTime, "RUP. " + _totalAmount, "Pending");
        orderList.add(order);
