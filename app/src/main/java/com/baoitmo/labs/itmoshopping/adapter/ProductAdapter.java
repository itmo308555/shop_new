package com.baoitmo.labs.itmoshopping.adapter;
...
import com.baoitmo.labs.itmoshopping.activity.BaseActivity;
import com.baoitmo.labs.itmoshopping.activity.ProductActivity;
import com.baoitmo.labs.itmoshopping.activity.ProductViewActivity;
import com.baoitmo.labs.itmoshopping.interfaces.AddorRemoveCallbacks;
import com.baoitmo.labs.itmoshopping.model.Cart;
        ...
        if (!cartList.isEmpty()) {
            for (int i = 0; i < cartList.size(); i++) {
                if (cartList.get(i).getId().equalsIgnoreCase(product.getId())) {
                    ...
                    holder.subTotal.setText(_quantity + "X" + _price + "= RUP." + _subtotal);
                ...
                if (pQuantity >= 1) {
                    ...
                    for (int i = 0; i < cartList.size(); i++) {
                        ...
                        if (cartList.get(i).getId().equalsIgnoreCase(product.getId())) {
                            ...
                            holder.subTotal.setText(total_item + "X" + holder.price.getText().toString() + "= RUP." + _subtotal);
